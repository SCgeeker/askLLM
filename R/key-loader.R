...
#' @return 中英雙語教學字串(先英文整段,再中文整段,與介面其他引導文字一致)
#' @export
key_setup_text <- function(provider_name, env_var, signup_url,
    ...
    paste(
        ...
        '',
        sprintf('1. Get a key at %s', signup_url),
        '',
        '2. Set the key (either way; Method A is simpler):',
        '',
        ...
        '   (depending on your OneDrive folder name)',
        '   Add one line:',
        sprintf('       %s=%s', env_var, key_example),
        '',
        '3. Fully quit and restart jamovi for the change to take effect.',
        '',
